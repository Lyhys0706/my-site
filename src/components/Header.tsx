    ...
    <header className="bg-gradient-to-r from-pink-200 to-pink-300 py-12 px-4 md:px-8">
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        ...
        <nav className="flex flex-wrap justify-center gap-4">
          <Link to="/" className="px-4 py-2 bg-pink-200 hover:bg-pink-300 rounded-full text-pink-800 font-medium transition-all">首页</Link>
          ...
          <Link to="/python-course" className="px-4 py-2 bg-pink-200 hover:bg-pink-300 rounded-full text-pink-800 font-medium transition-all">Python课程</Link>
